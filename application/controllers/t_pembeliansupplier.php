...
class t_pembeliansupplier extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['pembelian'] = $this->db->get('pembelian_supplier')->result();
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->db->insert('pembelian_supplier', $data);
    ...
    public function edit()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->db->update('pembelian_supplier', $data);
    ...
    public function hapus($id)
    {
        if ($id == "") {
            ...
            $this->db->delete('pembelian_supplier');
