<?php
class l_barangkeluar extends CI_Controller
{
    ...
    public function index()
    {
        ...
        // mencetak string 
        $pdf->Cell(190, 7, 'LAPORAN BARANG KELUAR SYO STORE', 0, 1, 'C');
        $pdf->SetFont('Arial', 'B', 12);
        $pdf->Cell(190, 7, 'DAFTAR BARANG TERJUAL', 0, 1, 'C');
        ...
        foreach ($mahasiswa as $row) {
            ...
            $pdf->Cell(38, 6, $row->tanggal_keluar, 1, 0);
