                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                ...
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                                        <div class="progress-bar bg-info" role="progressbar" style="<?= count($count_data) ?>" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="stats-link">
                                        <a href="<?php echo base_url("t_barangmasuk"); ?>">
                                            Lihat
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    ...
                                    <div class="stats-link">
                                        <a href="<?php echo base_url("t_barangkeluar"); ?>">
                                            Lihat
                                            <i class="fa fa-arrow-circle-o-right"></i>
                                        </a>
                                    </div>
