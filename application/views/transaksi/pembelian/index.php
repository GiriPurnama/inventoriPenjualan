<div class="row">
    <div class="col-lg">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php $i = 1; ?>
                <?php foreach ($pembelian as $bm) : ?>
                    <tr>
                        <th scope="row"><?= $i; ?></th>
                        <td><?= $bm->kode_barang; ?></td>
                        <td><?= $bm->nama_barang; ?></td>
                        <td><?= $bm->jumlah_barang; ?></td>
                        <td><?= $bm->tanggal_pembelian; ?></td>
                        ...
                        <?php if ($user['role_id'] == 2) { ?>
                            <td>
                                ...
                                <a href="<?= base_url('t_pembelian/hapus/' . $bm->kode_barang); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?= $bm->nama_barang; ?> ?');" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Hapus Data"><i class="fa fa-trash"></i></a>
                            </td>
                        <?php } ?>
                        <!-- akhir dari proses pengecekan -->
                    </tr>
...
<div class="modal fade" id="TambahModal" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url("t_pembelian/add"); ?>" method="post">
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="date" class="form-control" id="tanggal_pembelian" name="tanggal_pembelian" placeholder="Tanggal Masuk">
                            </div>
                            <div class="form-group col-md-5">
    ...
    <div class="modal fade" id="EditModal<?= $bm->kode_barang; ?>" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url("t_pembelian/edit"); ?>" method="post">
                    <div class="modal-body">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-5">
                                <label for="inputPassword4">Tanggal Masuk</label>
                                <input type="date" class="form-control" id="tanggal_pembelian" name="tanggal_pembelian" placeholder="Tanggal Masuk" value="<?= $bm->tanggal_pembelian; ?>">
                            </div>
                            <div class="form-group col-md-5">
                                <label for="inputCity">Harga Barang</label>
